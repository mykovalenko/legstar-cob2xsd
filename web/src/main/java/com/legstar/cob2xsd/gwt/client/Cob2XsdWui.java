...
public class Cob2XsdWui implements EntryPoint {
    ...
    public void onModuleLoad() {
        ...
        _cobolRuler1 = new Label(
                "0--------1---------2---------3---------4---------5---------6---------7---------8");
        _cobolRuler2 = new Label(
        ...
        _cobolTab
                .setToolTip("Edit or replace the sample COBOL structure, then click the Translate button");
    ...
    private FieldSet createXsdFieldSet() {
        ...
        _elementNamesStartWithUppercaseCheckBox
                .setBoxLabel("Start with uppercase");
        ...
        elementNamesStartWithUppercaseGroup
                .add(_elementNamesStartWithUppercaseCheckBox);
        ...
        _nameConflictPrependParentNameCheckBox
                .setBoxLabel("Prepend parent name");
        ...
        AsyncCallback < Cob2XsdServiceReply > callback = new AsyncCallback < Cob2XsdServiceReply >() {
            ...
            public void onFailure(Throwable caught) {
                ...
                if (caught instanceof Cob2XsdException) {
                    ...
                    for (String errorMessage : ((Cob2XsdException) caught)
                            .getErrorMessages()) {
